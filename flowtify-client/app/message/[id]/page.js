      ...
      <div class="w-full max-w-2xl">
        <form class="bg-gray-100 shadow-md rounded px-8 pt-6 pb-8 mb-4">
          ...
          <div class="mb-6">
            ...
            <textarea class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline h-32" id="msg" type="text" placeholder="Enter your message" />
          </div>
